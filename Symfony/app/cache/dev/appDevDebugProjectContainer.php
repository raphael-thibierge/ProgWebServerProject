...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '2a6d8e60a2e5678b09f60178a966079db47a080cb4e3ca18c66e6a79f16a8d1b_1' => 'get2a6d8e60a2e5678b09f60178a966079db47a080cb4e3ca18c66e6a79f16a8d1b1Service',
            '70a676044384fbbad99b4fc61192240cc5af2874aab120e1d74b5bb7a8285f5f_1' => 'get70a676044384fbbad99b4fc61192240cc5af2874aab120e1d74b5bb7a8285f5f1Service',
            '70a676044384fbbad99b4fc61192240cc5af2874aab120e1d74b5bb7a8285f5f_2' => 'get70a676044384fbbad99b4fc61192240cc5af2874aab120e1d74b5bb7a8285f5f2Service',
            '70a676044384fbbad99b4fc61192240cc5af2874aab120e1d74b5bb7a8285f5f_3' => 'get70a676044384fbbad99b4fc61192240cc5af2874aab120e1d74b5bb7a8285f5f3Service',
    ...
    /**
     * Gets the '2a6d8e60a2e5678b09f60178a966079db47a080cb4e3ca18c66e6a79f16a8d1b_1' service.
     *
     ...
     */
    protected function get2a6d8e60a2e5678b09f60178a966079db47a080cb4e3ca18c66e6a79f16a8d1b1Service()
    {
        return $this->services['2a6d8e60a2e5678b09f60178a966079db47a080cb4e3ca18c66e6a79f16a8d1b_1'] = new \Symfony\Component\Form\ResolvedFormTypeFactory();
    }

    /**
     * Gets the '70a676044384fbbad99b4fc61192240cc5af2874aab120e1d74b5bb7a8285f5f_1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get70a676044384fbbad99b4fc61192240cc5af2874aab120e1d74b5bb7a8285f5f1Service()
    {
        return $this->services['70a676044384fbbad99b4fc61192240cc5af2874aab120e1d74b5bb7a8285f5f_1'] = new \Swift_Transport_Esmtp_Auth_CramMd5Authenticator();
    }

    /**
     * Gets the '70a676044384fbbad99b4fc61192240cc5af2874aab120e1d74b5bb7a8285f5f_2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get70a676044384fbbad99b4fc61192240cc5af2874aab120e1d74b5bb7a8285f5f2Service()
    {
        return $this->services['70a676044384fbbad99b4fc61192240cc5af2874aab120e1d74b5bb7a8285f5f_2'] = new \Swift_Transport_Esmtp_Auth_LoginAuthenticator();
    }

    /**
     * Gets the '70a676044384fbbad99b4fc61192240cc5af2874aab120e1d74b5bb7a8285f5f_3' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get70a676044384fbbad99b4fc61192240cc5af2874aab120e1d74b5bb7a8285f5f3Service()
    {
        return $this->services['70a676044384fbbad99b4fc61192240cc5af2874aab120e1d74b5bb7a8285f5f_3'] = new \Swift_Transport_Esmtp_Auth_PlainAuthenticator();
    }
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_077b0a7aacaddbfe94488e7331e3fa272dce08146581f5038c6fbb82f7138e94');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_077b0a7aacaddbfe94488e7331e3fa272dce08146581f5038c6fbb82f7138e94');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_077b0a7aacaddbfe94488e7331e3fa272dce08146581f5038c6fbb82f7138e94');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '\\\\RAXUS.IUT.BX1\\WWW\\perso\\2016\\rthibierge\\Symfony\\src\\RT\\MusicBundle\\Entity')), 'RT\\MusicBundle\\Entity');
        ...
        $e->setProxyDir('//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/Resources');
    }
    ...
    {
        return $this->services['form.resolved_type_factory'] = new \Symfony\Component\Form\Extension\DataCollector\Proxy\ResolvedTypeFactoryDataCollectorProxy($this->get('2a6d8e60a2e5678b09f60178a966079db47a080cb4e3ca18c66e6a79f16a8d1b_1'), $this->get('data_collector.form'));
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file://RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/cache/dev/assetic/routing.yml', array('cache_dir' => '//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        $a = new \Swift_Transport_Esmtp_AuthHandler(array(0 => $this->get('70a676044384fbbad99b4fc61192240cc5af2874aab120e1d74b5bb7a8285f5f_1'), 1 => $this->get('70a676044384fbbad99b4fc61192240cc5af2874aab120e1d74b5bb7a8285f5f_2'), 2 => $this->get('70a676044384fbbad99b4fc61192240cc5af2874aab120e1d74b5bb7a8285f5f_3')));
        $a->setUsername(NULL);
        $a->setPassword(NULL);
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('\\\\RAXUS.IUT.BX1\\WWW\\perso\\2016\\rthibierge\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('\\\\RAXUS.IUT.BX1\\WWW\\perso\\2016\\rthibierge\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('\\\\RAXUS.IUT.BX1\\WWW\\perso\\2016\\rthibierge\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('\\\\RAXUS.IUT.BX1\\WWW\\perso\\2016\\rthibierge\\Symfony\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('\\\\RAXUS.IUT.BX1\\WWW\\perso\\2016\\rthibierge\\Symfony\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('\\\\RAXUS.IUT.BX1\\WWW\\perso\\2016\\rthibierge\\Symfony\\src\\RT\\appBundle/Resources/views', 'RTapp');
        $instance->addPath('\\\\RAXUS.IUT.BX1\\WWW\\perso\\2016\\rthibierge\\Symfony\\src\\RT\\MusicBundle/Resources/views', 'RTMusic');
        $instance->addPath('\\\\RAXUS.IUT.BX1\\WWW\\perso\\2016\\rthibierge\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('\\\\RAXUS.IUT.BX1\\WWW\\perso\\2016\\rthibierge\\Symfony\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/Resources/views');
        $instance->addPath('\\\\RAXUS.IUT.BX1\\WWW\\perso\\2016\\rthibierge\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('3084ad9b0d588926812e7fc322a272a6');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '\\\\RAXUS.IUT.BX1\\WWW\\perso\\2016\\rthibierge\\Symfony\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/cache/dev',
            'kernel.logs_dir' => '//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/logs',
            ...
            'locale' => 'en',
            'secret' => '3084ad9b0d588926812e7fc322a272a6',
            'debug_toolbar' => true,
            ...
            'debug.container.dump' => '//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'debug.debug_handlers_listener.class' => 'Symfony\\Component\\HttpKernel\\EventListener\\DebugHandlersListener',
            'kernel.secret' => '3084ad9b0d588926812e7fc322a272a6',
            ...
            'session.save_path' => '//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file://RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/cache/dev/profiler',
            ...
            'router.resource' => '//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/../web',
            'assetic.write_to' => '//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '//RAXUS.IUT.BX1/WWW/perso/2016/rthibierge/Symfony/app/cache/dev/doctrine/orm/Proxies',
